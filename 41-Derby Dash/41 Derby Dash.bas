1 v=53248:pokev+16,0:pokev+21,0:print"{clear}":dimh$(8),h(8),pl$(10),pl(10),i$(50),c$(50),b(10),t(10),be(10),ho(10):dimbe$(30):fori=1to6:h(i)=i:next:fori=1to10:t(i)=1000:next:poke53280,0:poke53281,0:print"{clear}{down*3}{space*10}{reverse on} d e r b y{space*2}d a s h 
