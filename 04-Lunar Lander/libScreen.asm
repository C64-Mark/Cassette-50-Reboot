...
;Print to the screen using the kernal CHROUT routine (no max)
defm 	LIBSCREEN_PRINTALL_A ;address of text
...
;Print to the screen using the kernal CHROUT routine with a delay between letters (max 255 chars)
defm 	LIBSCREEN_PRINT_DELAY_A ;address of text
